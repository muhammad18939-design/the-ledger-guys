  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-10 animate-fade-in">
      ...
      <div className="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-slate-200 relative overflow-hidden">
        {/* Premium Decorative Background Element */}
            ...
            <div className="p-8 md:p-12 overflow-y-auto print:overflow-visible print:p-0 relative z-10 bg-white">
              ...
              <div className="flex justify-between items-start border-b-2 border-slate-100 pb-8 mb-8">
                <div>
                  ...
                  <p className="text-slate-500 text-sm font-medium">Karachi, Pakistan</p>
                </div>
                <div className="text-right">
                  ...
                  <p className="font-bold text-[#0a1d37] text-sm uppercase tracking-wider">Doc No: <span className="font-medium text-slate-600 ml-2">#{Math.floor(Math.random() * 100000)}</span></p>
                </div>
              </div>
